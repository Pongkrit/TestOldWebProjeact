function getSearchProductName(event) {
    ...
    let rooturl = `http://localhost:8131/productsearch?name=${searchname}`;
    if(!searchname)  rooturl = `http://localhost:8131/products`;
        ...
        if (data.error) { // Check for error property
            ...
            if (products.length === 0) {
                ...
                products.forEach(product => {
                    ...
                    newProduct.href = "../../sec3_gr7_fe_src/Detail_Product_page/Detail_Product_Page.html?productID=" + product.ProductID;
...
function advancedSearch(event) {
    ...
    let rooturl = `http://localhost:8131/advancedSearchProduct?P_name=${name}`;
